...
const Header = () =>(<div className={"pageHeader"} style={{backgroundColor:"white",height:"20vh",marginBottom:"15px",display:"flex"}}>
    <img src={"/logo.png"} style={{height:"100px", marginTop:"10px" , marginLeft:"10px"}}/>
    <h1 style={{position:"relative",left:"300px",top:"50px",fontSize:"40px"}}>"To connect, empower, and grow"</h1>
</div>);
